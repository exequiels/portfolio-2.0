...
export async function POST(req: Request) {
  ...
  try {
    ...
    const systemPrompt = `
      ...
      2. **Justification (5–7 lines):** Explain the reasoning behind the score. If the score is not perfect, focus on transferable skills and how his background mitigates any technical gaps.
